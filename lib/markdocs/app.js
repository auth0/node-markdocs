...
function App(basePath, baseUrl, app){
  ...
  this._app.configure(function(){
    ...
    self._app.use(baseUrl, express.static(fspath.resolve(self._basePath, 'public')));
    self._app.use(baseUrl, express.static(fspath.resolve(self._themePath, 'public')));
  });

  //load docs
  this._docsPath = fspath.resolve(this._basePath, 'docs');
  this._docsByUrl = {};
